...
public class InputActivity extends AppCompatActivity {
    ...
    public void Mood(View view){
        ...
        ImageButton button1 = (ImageButton) findViewById(R.id.dead);
        ImageButton button2 = (ImageButton) findViewById(R.id.sad);
        ImageButton button3 = (ImageButton) findViewById(R.id.sadder);
        ImageButton button4 = (ImageButton) findViewById(R.id.smile);
